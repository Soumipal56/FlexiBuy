...
const products = [
  {
    ...
    variants: [
      { 
        ...
        images: ['https://placehold.co/400x500?text=iPhone+17+Pro+Silver'],
        emiPlans: generateEmiPlans(127400)
      },
      { 
        label: '256GB - Titanium', color: '#5c5b57', storage: '256GB', mrp: 134900, price: 127400, 
        images: ['https://placehold.co/400x500?text=iPhone+17+Pro+Titanium'],
        emiPlans: generateEmiPlans(127400)
      },
      { 
        label: '512GB - Gold', color: '#f0d9b5', storage: '512GB', mrp: 154900, price: 147400, 
        images: ['https://placehold.co/400x500?text=iPhone+17+Pro+Gold'],
  ...
  },
  {
    ...
    variants: [
      { 
        ...
        images: ['https://placehold.co/400x500?text=S24+Ultra+Black'],
        emiPlans: generateEmiPlans(119999)
      },
      { 
        label: '512GB - Grey', color: '#d1d1d1', storage: '512GB', mrp: 139999, price: 129999, 
        images: ['https://placehold.co/400x500?text=S24+Ultra+Grey'],
  ...
  },
  {
    ...
    variants: [
      { 
        ...
        images: ['https://placehold.co/400x500?text=Pixel+9+Pro+White'],
        emiPlans: generateEmiPlans(89999)
      },
      { 
        label: '256GB - Black', color: '#000000', storage: '256GB', mrp: 109999, price: 99999, 
        images: ['https://placehold.co/400x500?text=Pixel+9+Pro+Black'],
